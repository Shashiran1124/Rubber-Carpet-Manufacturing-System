  ...
  return (
    <SidebarContainer>
      ...
      {(user?.email === 'malidu@email.com'|| user?.email === 'first5@email.com') && (
        ...
        <StyledListItem button onClick={() => navigate('/suppliers')}>
          <ListItemIcon sx={{ color: '#fff' }}>
            <StorefrontIcon />
          </ListItemIcon>
        ...
        <StyledListItem button onClick={() => navigate('/distribution')}>
          <ListItemIcon sx={{ color: '#fff' }}>
            <LocalShippingIcon />
          </ListItemIcon>
       ...
       {(user?.email === 'emp@email.com' || user?.email === 'first5@email.com')&& (
        <StyledListItem button onClick={() => navigate('/empdashreports')}>
          <ListItemIcon sx={{ color: '#fff' }}>
            <PersonIcon />
          </ListItemIcon>
