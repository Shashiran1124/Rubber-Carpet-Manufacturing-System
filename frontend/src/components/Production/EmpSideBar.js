            ...
            <List sx={{ padding: 0 }}>
                ...
                <ListItem 
                    ...
                    sx={{ 
                        ...
                        backgroundColor: isActive(['/']) ? '#354a5f' : 'inherit' // Add active color effect
                    }} 
                    onClick={() => handleNavigation('/')}
                >
                    <HomeIcon sx={{ color: isActive(['/']) ? '#ffffff' : '#2c3e50' }} />
                </ListItem>
                ...
                <ListItem 
                    ...
                    sx={{ 
                        ...
                        borderRadius: '5px', 
                        margin: "5px", 
                        backgroundColor: isActive(['/empdashordertable']) ? '#A020F0' : 'inherit' 
                    }} 
