    ...
    return (
        <Box sx={{ width: "225px", backgroundColor: "#8D98A7", height: "230vh", paddingTop: "10px", borderRadius : "5px", border : "1.5px solid #000000" }}>
            <List sx={{ padding: 0 }}>
                ...
                <ListItem 
                    button 
                    sx={{ padding: "15px 20px", backgroundColor: isActive(['/Report']) ? '#191919' : 'inherit', borderRadius: "6px",width: "220px",border: "1.5px solid #000000", marginTop: "8px", marginBottom: "8px" }} 
                    onClick={() => handleNavigation('/Report')}
                >
                    <AssessmentIcon sx={{ color: isActive(['/Report']) ? '#fff' : '#000' }} />
                    <ListItemText primary="Reports" sx={{ paddingLeft: "10px", color: isActive(['/Report']) ? '#fff' : '#000' }} />
                </ListItem>
                <Divider sx={{ backgroundColor: "#fff" }} />
