    ...
    >
      <List sx={{ padding: 0 }}>
        ...
        <ListItem
          ...
          sx={{
            padding: "15px 20px",
            backgroundColor: isActive(["/salaryCal/add"])
              ? "#191919"
              : "inherit",
            borderRadius: "6px",
            width: "200px",
        ...
        >
          <ListItemText
            primary="Create Salary"
            sx={{
              paddingLeft: "10px",
              color: isActive(["/salaryCal/add"]) ? "#FFF" : "#000",
            }}
          />
        </ListItem>
        <Divider sx={{ backgroundColor: "#FFF" }} />
        ...
        <ListItem
          ...
          sx={{
            padding: "15px 20px",
            backgroundColor: isActive(["/salaryCal/all", "/DashOpForm"])
              ? "#191919"
              : "inherit",
            borderRadius: "6px",
            width: "200px",
        ...
        >
          <ListItemText
            ...
            sx={{
              paddingLeft: "10px",
              color: isActive(["/salaryCal/all", "/DashOpForm"])
                ? "#FFF"
                : "#000",
            }}
          />
        ...
        <ListItem
          ...
          sx={{
            padding: "15px 20px",
            backgroundColor: isActive(["/pettyCash/add"])
              ? "#191919"
              : "inherit",
            borderRadius: "6px",
            width: "200px",
        ...
        >
          <ListItemText
            primary="Pettycash adding"
            sx={{
              paddingLeft: "10px",
              color: isActive(["/pettyCash/add"]) ? "#FFFFFF" : "#000",
            }}
          />
        </ListItem>
        ...
        <ListItem
          ...
          sx={{
            padding: "15px 20px",
            backgroundColor: isActive(["/pettyCash/all"])
              ? "#191919"
              : "inherit",
            borderRadius: "6px",
            width: "200px",
        ...
        >
          <ListItemText
            primary=" PettyCash View"
            sx={{
              paddingLeft: "10px",
              color: isActive(["/pettyCash/all"]) ? "#FFF" : "#000",
            }}
          />
        </ListItem>
        ...
        <ListItem
          ...
          sx={{
            padding: "15px 20px",
            backgroundColor: isActive(["/profitAndLosts/add"])
              ? "#191919"
              : "inherit",
            borderRadius: "6px",
            width: "200px",
        ...
        >
          <ListItemText
            primary="Income Expenses Form "
            sx={{
              paddingLeft: "10px",
              color: isActive(["/profitAndLosts/add"]) ? "#FFF" : "#000",
            }}
          />
        </ListItem>
        <Divider sx={{ backgroundColor: "#FFF" }} />
        ...
        <ListItem
          ...
          sx={{
            padding: "15px 20px",
            backgroundColor: isActive(["/profitAndLosts/all"])
              ? "#191919"
              : "inherit",
            borderRadius: "6px",
            width: "200px",
        ...
        >
          <ListItemText
            ...
            sx={{
              paddingLeft: "10px",
              color: isActive(["/profitAndLosts/all"]) ? "#FFF" : "#000",
            }}
          />
        </ListItem>
        <Divider sx={{ backgroundColor: "#FFF" }} />
