...
let Salary = require("../models/SalaryCal") //should use machine model so import it (requir= import karana use karanva
...
router.route("/add").post((req,res)=>{  
    ...
    const newsalary = new Salary({ // Create a new instance of the machine model
        employeID,
        employeName,
        month,
        basicSalary,
