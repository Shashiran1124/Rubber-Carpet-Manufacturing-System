...
let repair = require("../../models/machinerepair/Repair"); //should use machine model so import it (requir= import karana use karanva)
...
router.route("/").get((req, res) => {
	...
	repair
		.find()
		.then((repair) => {
			//machin table eken ganne // kohomada ganne machine model eka cl karala
...
router.route("/update/:id").put(async (req, res) => {
	...
	const update = await repair
		.findByIdAndUpdate(rID, updateRepair)
		.then(() => {
